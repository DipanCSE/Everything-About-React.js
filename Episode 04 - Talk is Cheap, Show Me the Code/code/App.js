 ...
 * ----RestaurantCard
 * ----Img
 * ----Name of Restaurant, Star Rating, Cuisine, deliveryTimer.
 * Footer
 * ---Copyright
 * ---Links
 * ---Address
 * ---Contact
 * https://app.eraser.io/workspace/AhfCdDwErUpCT8A28GHK?origin=share(Plan Of the Project)
 */
  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://s3.amazonaws.com/logosnap/logos/2025/Jan/small-3810-679ca975ebc03.png"
          alt="BellyBox"
        />
      </div>
